...
begin
   ...
   Query.SQL.Add(' VALUES(:NOME,:ENDERECO,:CIDADE,:ESTADO,:CELULAR,:CEP,:CPF)');
...
begin
   ...
   Query.SQL.Add('ESTADO=:ESTADO,CELULAR=:CELULAR,CEP=:CEP,CPF=:CPF');
